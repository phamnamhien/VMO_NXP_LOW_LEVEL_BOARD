...
/** Channels number instance STM_2 */
#define STM_2_IP_CHANNELS_NUMBER  (4U)
#define STM_2_IP_EXISTS
#define STM_2_IP_INSTANCE_NUMBER (2U)
/** Channels number instance STM_3 */
#define STM_3_IP_CHANNELS_NUMBER  (4U)
#define STM_3_IP_EXISTS
#define STM_3_IP_INSTANCE_NUMBER (3U)
