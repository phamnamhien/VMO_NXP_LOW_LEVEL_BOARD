...
*/
#define DioConf_DioPort_DioPort_0  ((uint8)0x07U)
/**
* @brief          Symbolic name for the channel SDA_CH.
*
*/
#define DioConf_DioChannel_SDA_CH  ((uint16)0x0070U)
/**
* @brief          Symbolic name for the channel SCL_CH.
*
*/
#define DioConf_DioChannel_SCL_CH  ((uint16)0x0071U)
