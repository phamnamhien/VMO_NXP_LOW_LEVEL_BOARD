...
#define LPUART_UART_IP_PBCFG_SW_MAJOR_VERSION_C              6
...
#endif
    /* Runtime state structure refference */
    &Lpuart_Uart_Ip_apStateStructure[3U]
};
...
#endif
    /* Runtime state structure refference */
    &Lpuart_Uart_Ip_apStateStructure[4U]
};
...
#endif
    /* Runtime state structure refference */
    &Lpuart_Uart_Ip_apStateStructure[5U]
};
...
#endif
    /* Runtime state structure refference */
    &Lpuart_Uart_Ip_apStateStructure[7U]
};
...
#endif
    /* Runtime state structure refference */
    &Lpuart_Uart_Ip_apStateStructure[8U]
};
...
#endif
    /* Runtime state structure refference */
    &Lpuart_Uart_Ip_apStateStructure[9U]
};
