...
#define GMAC_IP_PBCFG_SW_MAJOR_VERSION_C              6
...
/* Checks against Gmac_Ip_Cfg.h */
    ...
    #if ((GMAC_IP_PBCFG_AR_RELEASE_MAJOR_VERSION_C != MCAL_AR_RELEASE_MAJOR_VERSION) || \
         (GMAC_IP_PBCFG_AR_RELEASE_MINOR_VERSION_C != MCAL_AR_RELEASE_MINOR_VERSION)    \
        )
        #error "AUTOSAR Version Numbers of Gmac_Ip_PBcfg.c and Mcal.h are different"
    #endif
#endif
