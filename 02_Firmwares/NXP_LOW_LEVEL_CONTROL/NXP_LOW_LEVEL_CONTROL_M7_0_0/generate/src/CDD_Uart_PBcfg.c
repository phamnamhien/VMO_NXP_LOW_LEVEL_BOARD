...
#define UART_PBCFG_SW_MAJOR_VERSION_C              6
...
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_3 =
{
    (uint8)3U, /* Uart Channel ID */
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART_PARTITION_ID, /* Uart Channel Partition ID */
#endif
    (uint32)80000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_3  /* Pointer to the hardware configuration */
};
/**
...
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_4 =
{
    (uint8)4U, /* Uart Channel ID */
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART_PARTITION_ID, /* Uart Channel Partition ID */
#endif
    (uint32)80000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_4  /* Pointer to the hardware configuration */
};
/**
* @brief          Configuration for Uart Channel 5
*
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_5 =
{
    (uint8)5U, /* Uart Channel ID */
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART_PARTITION_ID, /* Uart Channel Partition ID */
#endif
    (uint32)80000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_5  /* Pointer to the hardware configuration */
};
/**
* @brief          Configuration for Uart Channel 6
*
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_6 =
{
    (uint8)6U, /* Uart Channel ID */
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART_PARTITION_ID, /* Uart Channel Partition ID */
#endif
    (uint32)80000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_6  /* Pointer to the hardware configuration */
};
/**
* @brief          Configuration for Uart Channel 7
*
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_7 =
{
    (uint8)7U, /* Uart Channel ID */
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART_PARTITION_ID, /* Uart Channel Partition ID */
#endif
    (uint32)80000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_7  /* Pointer to the hardware configuration */
};
/**
* @brief          Configuration for Uart Channel 8
*
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_8 =
{
    (uint8)8U, /* Uart Channel ID */
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART_PARTITION_ID, /* Uart Channel Partition ID */
#endif
    (uint32)80000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_8  /* Pointer to the hardware configuration */
};
/**
* @brief          Configuration for Uart Channel 9
*
*
*/
static const Uart_ChannelConfigType Uart_ChannelConfig_9 =
{
    (uint8)9U, /* Uart Channel ID */
#if (UART_MULTIPARTITION_SUPPORT == STD_ON)
    (uint32)UART_PARTITION_ID, /* Uart Channel Partition ID */
#endif
    (uint32)80000000U, /* Clock frequency */
    &Uart_Ipw_xHwConfigPB_9  /* Pointer to the hardware configuration */
};
...
,
        &Uart_ChannelConfig_3
,
        &Uart_ChannelConfig_4
,
        &Uart_ChannelConfig_5
,
        &Uart_ChannelConfig_6
,
        &Uart_ChannelConfig_7
,
        &Uart_ChannelConfig_8
,
        &Uart_ChannelConfig_9
    }
};
