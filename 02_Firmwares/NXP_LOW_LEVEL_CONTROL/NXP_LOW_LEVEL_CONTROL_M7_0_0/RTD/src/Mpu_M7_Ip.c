...
#define CDD_PLATFORM_MPU_M7_IP_SW_MAJOR_VERSION_C               6
                                         ...
                                         )
{
    ...
    u32RegionSize = Mpu_M7_Ip_CalculateRegionSize(pUserConfigPtr->u32StartAddr, pUserConfigPtr->u32EndAddr);

#if (MPU_M7_IP_DEV_ERROR_DETECT == STD_ON)
    /* Check if the region start address is aligned to the region's size */
    DevAssert((pUserConfigPtr->u32StartAddr & ((1UL << u32RegionSize) - 1UL)) == 0UL);
#endif
