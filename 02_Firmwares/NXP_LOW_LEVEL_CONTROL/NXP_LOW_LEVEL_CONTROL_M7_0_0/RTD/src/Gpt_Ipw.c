...
#define GPT_IPW_SW_MAJOR_VERSION_C             6
...
static Gpt_ValueType Gpt_Ipw_PitGetTimeElapsed(const Gpt_Ipw_HwChannelConfigType * pHwChannelConfig, Gpt_HwChannelInfoType * pReturnHwChannelInfo)
{
    ...
    uint64 tempTime = pReturnHwChannelInfo->uTargetTime - (uint64)Pit_Ip_GetCurrentTimer(pHwChannelConfig->instance, pHwChannelConfig->channel);
    Gpt_ValueType returnValue = (Gpt_ValueType)tempTime;
