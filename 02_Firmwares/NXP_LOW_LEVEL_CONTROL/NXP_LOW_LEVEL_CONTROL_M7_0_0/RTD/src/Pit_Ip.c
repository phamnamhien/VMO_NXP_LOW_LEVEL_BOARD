...
#define PIT_IP_SW_MAJOR_VERSION_C             6
...
#include "Gpt_MemMap.h"
        ...
        defined(CPE_PIT_0_ISR_USED) || defined(CPE_PIT_1_ISR_USED) || defined(LPE_PIT_RTI_ISR_USED) || \
...
#if defined(COSS_PIT_0_ISR_USED)
ISR(COSS_PIT_0_ISR);
#endif
#if defined(COSS_PIT_1_ISR_USED)
ISR(COSS_PIT_1_ISR);
#endif
#if defined(COSS_PIT_2_ISR_USED)
ISR(COSS_PIT_2_ISR);
#endif
#if defined(COSS_PIT_3_ISR_USED)
ISR(COSS_PIT_3_ISR);
#endif
#if defined(COSS_PIT_4_ISR_USED)
ISR(COSS_PIT_4_ISR);
#endif
#if defined(COSS_PIT_5_ISR_USED)
ISR(COSS_PIT_5_ISR);
#endif
#if defined(COSS_PIT_6_ISR_USED)
ISR(COSS_PIT_6_ISR);
#endif

#if defined(RCU_PIT_0_ISR_USED)
ISR(RCU_PIT_0_ISR);
#endif
#if defined(RCU_PIT_1_ISR_USED)
ISR(RCU_PIT_1_ISR);
#endif
#if defined(RCU_PIT_2_ISR_USED)
ISR(RCU_PIT_2_ISR);
#endif
#if defined(RCU_PIT_3_ISR_USED)
ISR(RCU_PIT_3_ISR);
#endif
#if defined(RCU_PIT_4_ISR_USED)
ISR(RCU_PIT_4_ISR);
#endif
#if defined(RCU_PIT_5_ISR_USED)
ISR(RCU_PIT_5_ISR);
#endif
#if defined(RCU_PIT_6_ISR_USED)
ISR(RCU_PIT_6_ISR);
#endif
#if defined(RCU_PIT_7_ISR_USED)
ISR(RCU_PIT_7_ISR);
#endif
#if defined(RCU_PIT_8_ISR_USED)
ISR(RCU_PIT_8_ISR);
#endif
#if defined(RCU_PIT_9_ISR_USED)
ISR(RCU_PIT_9_ISR);
#endif
#if defined(RCU_PIT_10_ISR_USED)
ISR(RCU_PIT_10_ISR);
#endif
#if defined(RCU_PIT_11_ISR_USED)
ISR(RCU_PIT_11_ISR);
#endif
#if defined(RCU_PIT_12_ISR_USED)
ISR(RCU_PIT_12_ISR);
#endif
#if defined(RCU_PIT_13_ISR_USED)
ISR(RCU_PIT_13_ISR);
#endif
...
#if defined(CPE_PIT_0_ISR_USED)
ISR(CPE_PIT_0_ISR);
#endif
#if defined(CPE_PIT_1_ISR_USED)
ISR(CPE_PIT_1_ISR);
#endif
#if defined(LPE_PIT_RTI_ISR_USED)
ISR(LPE_PIT_RTI_ISR);
#endif
...
#if defined(COSS_PIT_0_ISR_USED)
/**
* @brief   Interrupt handler for COSS_PIT_0 channels.
* @details Interrupt Service Routine corresponding to COSS_PIT_0 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(COSS_PIT_0_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(COSS_PIT_0_IP_EXISTS)
    uint8 instance = COSS_PIT_0_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < COSS_PIT_0_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(COSS_PIT_1_ISR_USED)
/**
* @brief   Interrupt handler for COSS_PIT_1 channels.
* @details Interrupt Service Routine corresponding to COSS_PIT_1 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(COSS_PIT_1_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(COSS_PIT_1_IP_EXISTS)
    uint8 instance = COSS_PIT_1_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < COSS_PIT_1_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(COSS_PIT_2_ISR_USED)
/**
* @brief   Interrupt handler for COSS_PIT_2 channels.
* @details Interrupt Service Routine corresponding to COSS_PIT_2 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(COSS_PIT_2_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(COSS_PIT_2_IP_EXISTS)
    uint8 instance = COSS_PIT_2_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < COSS_PIT_2_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(COSS_PIT_3_ISR_USED)
/**
* @brief   Interrupt handler for COSS_PIT_3 channels.
* @details Interrupt Service Routine corresponding to COSS_PIT_3 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(COSS_PIT_3_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(COSS_PIT_3_IP_EXISTS)
    uint8 instance = COSS_PIT_3_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < COSS_PIT_3_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(COSS_PIT_4_ISR_USED)
/**
* @brief   Interrupt handler for COSS_PIT_4 channels.
* @details Interrupt Service Routine corresponding to COSS_PIT_4 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(COSS_PIT_4_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(COSS_PIT_4_IP_EXISTS)
    uint8 instance = COSS_PIT_4_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < COSS_PIT_4_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(COSS_PIT_5_ISR_USED)
/**
* @brief   Interrupt handler for COSS_PIT_5 channels.
* @details Interrupt Service Routine corresponding to COSS_PIT_5 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(COSS_PIT_5_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(COSS_PIT_5_IP_EXISTS)
    uint8 instance = COSS_PIT_5_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < COSS_PIT_5_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(COSS_PIT_6_ISR_USED)
/**
* @brief   Interrupt handler for COSS_PIT_6 channels.
* @details Interrupt Service Routine corresponding to COSS_PIT_6 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(COSS_PIT_6_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(COSS_PIT_6_IP_EXISTS)
    uint8 instance = COSS_PIT_6_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < COSS_PIT_6_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_0_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_0 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_0 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_0_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_0_IP_EXISTS)
    uint8 instance = RCU_PIT_0_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_0_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_1_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_1 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_1 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(RCU_PIT_1_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_1_IP_EXISTS)
    uint8 instance = RCU_PIT_1_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_1_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_2_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_2 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_2 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_2_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_2_IP_EXISTS)
    uint8 instance = RCU_PIT_2_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_2_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_3_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_3 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_3 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(RCU_PIT_3_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_3_IP_EXISTS)
    uint8 instance = RCU_PIT_3_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_3_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_4_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_4 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_4 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_4_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_4_IP_EXISTS)
    uint8 instance = RCU_PIT_4_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_4_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_5_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_5 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_5 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(RCU_PIT_5_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_5_IP_EXISTS)
    uint8 instance = RCU_PIT_5_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_5_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_6_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_6 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_6 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_6_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_6_IP_EXISTS)
    uint8 instance = RCU_PIT_6_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_6_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_7_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_7 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_7 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_7_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_7_IP_EXISTS)
    uint8 instance = RCU_PIT_7_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_7_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_8_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_8 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_8 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(RCU_PIT_8_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_8_IP_EXISTS)
    uint8 instance = RCU_PIT_8_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_8_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_9_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_9 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_9 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_9_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_9_IP_EXISTS)
    uint8 instance = RCU_PIT_9_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_9_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_10_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_10 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_10 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(RCU_PIT_10_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_10_IP_EXISTS)
    uint8 instance = RCU_PIT_10_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_10_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_11_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_11 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_11 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_11_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_11_IP_EXISTS)
    uint8 instance = RCU_PIT_11_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_11_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_12_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_12 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_12 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(RCU_PIT_12_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_12_IP_EXISTS)
    uint8 instance = RCU_PIT_12_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_12_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(RCU_PIT_13_ISR_USED)
/**
* @brief   Interrupt handler for RCU_PIT_13 channels.
* @details Interrupt Service Routine corresponding to RCU_PIT_13 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(RCU_PIT_13_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(RCU_PIT_13_IP_EXISTS)
    uint8 instance = RCU_PIT_13_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < RCU_PIT_13_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(CPE_PIT_0_ISR_USED)
/**
* @brief   Interrupt handler for CPE_PIT_0 channels.
* @details Interrupt Service Routine corresponding to CPE_PIT_0 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(CPE_PIT_0_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(CPE_PIT_0_IP_EXISTS)
    uint8 instance = CPE_PIT_0_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < CPE_PIT_0_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(CPE_PIT_1_ISR_USED)
/**
* @brief   Interrupt handler for CPE_PIT_1 channels.
* @details Interrupt Service Routine corresponding to CPE_PIT_1 hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized.
...
ISR(CPE_PIT_1_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(CPE_PIT_1_IP_EXISTS)
    uint8 instance = CPE_PIT_1_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < CPE_PIT_1_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
...
#if defined(LPE_PIT_RTI_ISR_USED)
/**
* @brief   Interrupt handler for LPE_PIT_RTI channels.
* @details Interrupt Service Routine corresponding to LPE_PIT_RTI hw module.
* @param[in] none
* @return  void
* @isr
* @pre      The driver needs to be initialized
...
ISR(LPE_PIT_RTI_ISR)
{
    uint8 channel;
    boolean HasChEvOccurred;
#if defined(LPE_PIT_RTI_IP_EXISTS)
    uint8 instance = LPE_PIT_RTI_IP_INSTANCE_NUMBER;
#else
    #error "undefined PIT instance number"
#endif
    for (channel = 0U; channel < LPE_PIT_RTI_IP_CHANNELS_NUMBER; ++channel)
    {
        /* check if channel event has occurred */
        HasChEvOccurred = Pit_Ip_GetInterruptStatusFlag(instance, channel);
        if (TRUE == HasChEvOccurred)
