...
#define ETH_43_GMAC_IPW_SW_MAJOR_VERSION_C               6
...
* @return        void
*/
void Eth_43_GMAC_Ipw_TxRxClkMuxBypass(uint8 CtrlIdx, const Eth_43_GMAC_Ipw_TxRxClkMuxBypassType TxRxClkMuxBypass)
{
    if (CtrlIdx < 1U)
    {
    #if defined(S32K389)
        IP_DCM_GPR->DCMRWF2 = (IP_DCM_GPR->DCMRWF2 & ~DCM_GPR_DCMRWF2_MAC_TX_RX_CLK_MUX_BYPASS_MASK) | (TxRxClkMuxBypass.Eth_43_GMAC_Ipw_DCMRWF2);
    #endif
        IP_DCM_GPR->DCMRWF3 = (IP_DCM_GPR->DCMRWF3 & ~(DCM_GPR_DCMRWF3_MAC_TX_CLK_MUX_BYPASS_MASK | DCM_GPR_DCMRWF3_MAC_RX_CLK_MUX_BYPASS_MASK)) | (TxRxClkMuxBypass.Eth_43_GMAC_Ipw_DCMRWF3);
    #if (defined(S32K388) || defined(S32K389))
        IP_DCM_GPR->DCMRWF4 = (IP_DCM_GPR->DCMRWF4 & ~DCM_GPR_DCMRWF4_MAC_RMII_CLK_MUX_BYPASS_MASK) | (TxRxClkMuxBypass.Eth_43_GMAC_Ipw_DCMRWF4);
    #endif
    }
    else
    {
    #if defined(S32K388)
        IP_DCM_GPR->DCMRWF4 = (IP_DCM_GPR->DCMRWF4 & ~(DCM_GPR_DCMRWF4_MAC2_TX_CLK_MUX_BYPASS_MASK | DCM_GPR_DCMRWF4_MAC2_RX_CLK_MUX_BYPASS_MASK | DCM_GPR_DCMRWF4_MAC2_RMII_CLK_MUX_BYPASS_MASK)) | (TxRxClkMuxBypass.Eth_43_GMAC_Ipw_DCMRWF4);
    #elif defined(S32K389)
        IP_DCM_GPR->DCMRWF4 = (IP_DCM_GPR->DCMRWF4 & ~(DCM_GPR_DCMRWF4_MAC2_TX_RX_CLK_MUX_BYPASS_MASK | DCM_GPR_DCMRWF4_MAC2_TX_CLK_MUX_BYPASS_MASK | DCM_GPR_DCMRWF4_MAC2_RX_CLK_MUX_BYPASS_MASK | DCM_GPR_DCMRWF4_MAC2_RMII_CLK_MUX_BYPASS_MASK)) | (TxRxClkMuxBypass.Eth_43_GMAC_Ipw_DCMRWF4);
    #endif
    }
}
#endif
